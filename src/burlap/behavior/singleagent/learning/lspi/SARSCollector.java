...
/**
 * This object is used to collect {@link SARSData} (state-action-reward-state tuples) that can then be used by
 * algorithms like LSPI for learning.
...
public abstract class SARSCollector {
	 ...
	 * @param maxEpisodeSteps the maximum number of steps that can be taken when rolling out from a state generated by
	 *        {@link StateGenerator} sg, before a new rollout is started.
